jQuery(document).ready(function ($) {
  ...
  function replaceDefaultImage(shortId) {
    ...
    glo3dIFrame.setAttribute(
      "src",
      `https://glo3d.net/iFrame/${shortId}?amp;autoRotate=true&footerGallery=true&condition=true&interior=true&themebgcolor=151x35x42&themetextcolor=white&galleryPositin=Bottom`
    );
    ...
    $(".product-gallery").replaceWith(wrapper);
  ...
  function findVin() {
    const vin = document
      .querySelector(".arVDP-details-vin")
      .textContent.split(":")[1]
      .trim();
    if (vin) {
      return vin;
