jQuery(document).ready(function ($) {
  ...
  function replaceDefaultImage(shortId) {
    ...
    glo3dIFrame.setAttribute(
      "src",
      `https://glo3d.net/iFrame/${shortId}?amp;autoRotate=true&footerGallery=true&condition=true&interior=true&themebgcolor=193x39x44&themetextcolor=white&galleryPositin=Bottom`
    );
    ...
    $(".vc_custom_1491468533987").replaceWith(wrapper);
