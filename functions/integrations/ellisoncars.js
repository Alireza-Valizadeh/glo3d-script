jQuery(document).ready(function ($) {
    ...
    function replaceDefaultImage(shortId) {
      ...
      glo3dIFrame.setAttribute(
        "src",
        `https://glo3d.net/iFrame/${shortId}?amp;autoRotate=true&footerGallery=true&condition=true&interior=true&themebgcolor=204x24x31&themetextcolor=white&galleryPositin=Bottom`
      );
      ...
      document.querySelector(".main-pic").style.width = 0;
      try {
        $(".img-list").remove();
