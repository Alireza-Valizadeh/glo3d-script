jQuery(document).ready(function ($) {
  ...
  function replaceDefaultImage(shortId) {
    ...
    glo3dIFrame.setAttribute(
      "src",
      `https://glo3d.net/iFrame/${shortId}?amp;autoRotate=true&footerGallery=true&condition=true&interior=true&themebgcolor=215x36x36&themetextcolor=white&galleryPositin=Bottom`
    );
  ...
  function findVin() {
    var vin =
      $(`div:contains("VIN")`)[8].parentElement.nextSibling.nextSibling
        .innerText;
    console.log("vin", vin);
    if (vin) {
      try {
