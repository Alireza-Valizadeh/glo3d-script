jQuery(document).ready(function ($) {
  ...
  function replaceDefaultImage(shortId) {
    ...
    glo3dIFrame.setAttribute(
      "src",
      `https://glo3d.net/iFrame/${shortId}?amp;autoRotate=true&footerGallery=true&condition=true&interior=true&themebgcolor=255x255x255&themetextcolor=black&galleryPositin=Bottom`
    );
    ...
    wrapper.appendChild(glo3dIFrame);
    $(".splide").replaceWith(wrapper);
    const sliderText = document.querySelector(".vdp-gallery-slider-start");
    $(sliderText.parentNode).remove();
